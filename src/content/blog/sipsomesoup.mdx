...
This was the invite that was haphazardly put together with a combination of actual google slides and the ARC browser canvas:

<Image src={invite} alt="invite" style="width: 100%; height: auto;"/>
